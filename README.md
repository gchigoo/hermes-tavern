...
/rp scene beat add <scene-id> <label> <beat...> | /rp scene beat list <scene-id> | /rp scene beat inspect <beat-id> | /rp scene beat update <beat-id> <beat...> | /rp scene beat delete <beat-id> | /rp scene beat export <beat-id>
...
/rp scene narration tense <scene-id> <past|present> | /rp scene export <scene-id>
/rp canon add/list/group | /rp canon inspect <canon-id> | /rp canon export <canon-id> | /rp timeline add/list | /rp timeline inspect <timeline-id> | /rp timeline export <timeline-id>
