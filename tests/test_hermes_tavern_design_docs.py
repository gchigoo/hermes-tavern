...
ACCEPTED_PHASE_528_STATUS = "Current status (2026-06-18): All phases 1-528 accepted"
...
def test_design_docs_use_the_canonical_implementation_plan_path() -> None:
    ...
    assert ACCEPTED_PHASE_528_STATUS in attention_text
    assert attention_text.count("Phase 525 phase524 post-commit record plan") == 1
    assert "Phase " + "529" not in attention_text
