...
CURRENT_STATUS_PREFIX = "Current status (2026-06-13): All phases 1-215 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-13): All phases 1-214 accepted"
STALE_PHASE_MARKER = "1-214"
STALE_PHASE_MARKER_EN_DASH = "1–214"
...
FINAL_STATUS_SUFFIX = "Phase 213 attention status sync through Phase 212, Phase 214 attention status sync through Phase 213, and Phase 215 attention status sync through Phase 214."
...
def test_attention_current_status_line_is_current():
    ...
    assert all(f"Phase {phase} " in status for phase in range(168, 216))
