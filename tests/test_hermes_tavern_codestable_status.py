...
STALE_PHASE_MARKER = "1-246"
STALE_PHASE_MARKER_EN_DASH = "1–246"
...
def test_attention_current_status_line_is_current():
    ...
    assert all(f"Phase {phase} " in status for phase in range(168, 248))
    ...
    expected_phase_range = "range(" + "168" + ", 24" + "8)"
    stale_phase_range = "".join(["range(168, ", str(246 + 1), ")"])
