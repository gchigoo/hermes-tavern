...
CURRENT_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-501 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-500 accepted"
STALE_PHASE_MARKER = "1-500"
STALE_PHASE_MARKER_EN_DASH = "1–500"
OLDER_STALE_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-499 accepted"
OLDER_STALE_PHASE_MARKER = "1-499"
OLDER_STALE_PHASE_MARKER_EN_DASH = "1–499"
HISTORIC_STALE_PHASE_MARKER = "1-498"
HISTORIC_STALE_PHASE_MARKER_EN_DASH = "1–498"
OLDEST_STALE_PHASE_MARKER = "1-497"
OLDEST_STALE_PHASE_MARKER_EN_DASH = "1–497"
...
FINAL_STATUS_SUFFIX = "Phase 497 attention status sync through Phase 496, Phase 498 attention status sync through Phase 497, Phase 499 attention status sync through Phase 498, Phase 500 attention status sync through Phase 499, and Phase 501 attention status sync through Phase 500."
...
def test_attention_current_status_line_is_current():
    ...
    assert len(REQUIRED_PHASE_LABELS) == 334
    ...
    phase_range = range(168, 502)
    aggregate_range = "range(168, 502)"
