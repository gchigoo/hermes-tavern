...
CURRENT_STATUS_PREFIX = "Current status (2026-06-13): All phases 1-212 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-13): All phases 1-211 accepted"
STALE_PHASE_MARKER = "1-211"
STALE_PHASE_MARKER_EN_DASH = "1–211"
...
FINAL_STATUS_SUFFIX = "Phase 210 attention status sync through Phase 209, Phase 211 attention status sync through Phase 210, and Phase 212 attention status sync through Phase 211."
...
def test_attention_current_status_line_is_current():
    ...
    assert all(f"Phase {phase} " in status for phase in range(168, 213))
