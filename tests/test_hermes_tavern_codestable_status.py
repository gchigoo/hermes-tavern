...
CURRENT_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-508 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-507 accepted"
STALE_PHASE_MARKER = "1-507"
STALE_PHASE_MARKER_EN_DASH = "1–507"
OLDER_STALE_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-506 accepted"
OLDER_STALE_PHASE_MARKER = "1-506"
OLDER_STALE_PHASE_MARKER_EN_DASH = "1–506"
HISTORIC_STALE_PHASE_MARKER = "1-505"
HISTORIC_STALE_PHASE_MARKER_EN_DASH = "1–505"
OLDEST_STALE_PHASE_MARKER = "1-504"
OLDEST_STALE_PHASE_MARKER_EN_DASH = "1–504"
...
FINAL_STATUS_SUFFIX = "Phase 504 attention status sync through Phase 503, Phase 505 attention status sync through Phase 504, Phase 506 attention status sync through Phase 505, Phase 507 attention status sync through Phase 506, and Phase 508 attention status sync through Phase 507."
...
def test_attention_current_status_line_is_current():
    ...
    assert len(REQUIRED_PHASE_LABELS) == 341
    ...
    phase_range = range(168, 509)
    aggregate_range = "range(168, 509)"
    stale_old_range = f"range(168, {phase_range.stop - 1})"
    ...
    assert stale_old_range not in test
