...
CURRENT_STATUS_PREFIX = "Current status (2026-06-13): All phases 1-213 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-13): All phases 1-212 accepted"
STALE_PHASE_MARKER = "1-212"
STALE_PHASE_MARKER_EN_DASH = "1–212"
...
FINAL_STATUS_SUFFIX = "Phase 211 attention status sync through Phase 210, Phase 212 attention status sync through Phase 211, and Phase 213 attention status sync through Phase 212."
...
def test_attention_current_status_line_is_current():
    ...
    assert all(f"Phase {phase} " in status for phase in range(168, 214))
