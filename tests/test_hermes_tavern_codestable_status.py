...
CURRENT_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-507 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-506 accepted"
STALE_PHASE_MARKER = "1-506"
STALE_PHASE_MARKER_EN_DASH = "1–506"
OLDER_STALE_STATUS_PREFIX = "Current status (2026-06-18): All phases 1-505 accepted"
OLDER_STALE_PHASE_MARKER = "1-505"
OLDER_STALE_PHASE_MARKER_EN_DASH = "1–505"
HISTORIC_STALE_PHASE_MARKER = "1-504"
HISTORIC_STALE_PHASE_MARKER_EN_DASH = "1–504"
OLDEST_STALE_PHASE_MARKER = "1-503"
OLDEST_STALE_PHASE_MARKER_EN_DASH = "1–503"
...
FINAL_STATUS_SUFFIX = "Phase 503 attention status sync through Phase 502, Phase 504 attention status sync through Phase 503, Phase 505 attention status sync through Phase 504, Phase 506 attention status sync through Phase 505, and Phase 507 attention status sync through Phase 506."
...
def test_attention_current_status_line_is_current():
    ...
    assert len(REQUIRED_PHASE_LABELS) == 340
    ...
    phase_range = range(168, 508)
    aggregate_range = "range(168, 508)"
