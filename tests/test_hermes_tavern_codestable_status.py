...
CURRENT_STATUS_PREFIX = "Current status (2026-06-15): All phases 1-261 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-15): All phases 1-260 accepted"
STALE_PHASE_MARKER = "1-260"
STALE_PHASE_MARKER_EN_DASH = "1–260"
...
FINAL_STATUS_SUFFIX = "Phase 259 attention status sync through Phase 258, Phase 260 attention status sync through Phase 259, and Phase 261 attention status sync through Phase 260."
...
def test_attention_current_status_line_is_current():
    ...
    stale_aggregate_range_not_literal = "".join(["range(168, ", "2", "61", ")"])
    assert stale_aggregate_range_not_literal not in test
    aggregate_range = "range(168, 262)"
