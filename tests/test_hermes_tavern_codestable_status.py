...
CURRENT_STATUS_PREFIX = "Current status (2026-06-14): All phases 1-223 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-14): All phases 1-222 accepted"
STALE_PHASE_MARKER = "1-222"
STALE_PHASE_MARKER_EN_DASH = "1–222"
...
FINAL_STATUS_SUFFIX = "Phase 221 attention status sync through Phase 220, Phase 222 attention status sync through Phase 221, and Phase 223 attention status sync through Phase 222."
...
def test_attention_current_status_line_is_current():
    ...
    assert all(f"Phase {phase} " in status for phase in range(168, 224))
