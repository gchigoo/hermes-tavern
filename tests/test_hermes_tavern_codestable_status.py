...
CURRENT_STATUS_PREFIX = "Current status (2026-06-14): All phases 1-222 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-14): All phases 1-221 accepted"
STALE_PHASE_MARKER = "1-221"
STALE_PHASE_MARKER_EN_DASH = "1–221"
...
FINAL_STATUS_SUFFIX = "Phase 220 attention status sync through Phase 219, Phase 221 attention status sync through Phase 220, and Phase 222 attention status sync through Phase 221."
...
def test_attention_current_status_line_is_current():
    ...
    assert all(f"Phase {phase} " in status for phase in range(168, 223))
