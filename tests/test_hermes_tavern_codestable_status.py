...
CURRENT_STATUS_PREFIX = "Current status (2026-06-15): All phases 1-264 accepted"
STALE_STATUS_PREFIX = "Current status (2026-06-15): All phases 1-263 accepted"
STALE_PHASE_MARKER = "1-263"
STALE_PHASE_MARKER_EN_DASH = "1–263"
...
FINAL_STATUS_SUFFIX = "Phase 262 attention status sync through Phase 261, Phase 263 attention status sync through Phase 262, and Phase 264 attention status sync through Phase 263."
...
def test_attention_current_status_line_is_current():
    ...
    stale_aggregate_range_not_literal = "".join(["range(168, ", "26", "4", ")"])
    assert stale_aggregate_range_not_literal not in test
    aggregate_range = "range(168, 265)"
    assert aggregate_range in test
    stale_aggregate_range = "".join(["range(168, ", "26", "4", ")"])
